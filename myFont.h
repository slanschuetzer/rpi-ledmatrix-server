//
// Created by slanschuetzer on 26.10.20.
//

#ifndef RPI_LEDMATRIX_SERVER_MYFONT_H
#define RPI_LEDMATRIX_SERVER_MYFONT_H

const unsigned char font[112][8] = {
        {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, //
        {0x5f,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // !
        {0x03,0x00,0x03,0x00,0x00,0x00,0x00,0x00}, // "
        {0x14,0x7f,0x14,0x7f,0x14,0x00,0x00,0x00}, // #
        {0x24,0x2a,0x6b,0x2a,0x12,0x00,0x00,0x00}, // $
        {0x43,0x30,0x08,0x06,0x61,0x00,0x00,0x00}, // %
        {0x30,0x4a,0x5d,0x32,0x48,0x00,0x00,0x00}, // &
        {0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // '
        {0x1c,0x22,0x41,0x41,0x00,0x00,0x00,0x00}, // (
        {0x41,0x41,0x22,0x1c,0x00,0x00,0x00,0x00}, // )
        {0x05,0x02,0x02,0x05,0x00,0x00,0x00,0x00}, // *
        ...
        {0x18,0x14,0x12,0x11,0x7f,0x00,0x00,0x00}, // 4
        ...
        {0x3e,0x41,0x5d,0x5d,0x51,0x5e,0x00,0x00}, // @
        {0x7e,0x05,0x05,0x05,0x7e,0x00,0x00,0x00}, // A
        {0x7f,0x45,0x45,0x45,0x3a,0x00,0x00,0x00}, // B
        {0x3e,0x41,0x41,0x41,0x22,0x00,0x00,0x00}, // C
        {0x7f,0x41,0x41,0x41,0x3e,0x00,0x00,0x00}, // D
        {0x7f,0x45,0x45,0x41,0x41,0x00,0x00,0x00}, // E
        {0x7f,0x05,0x05,0x01,0x01,0x00,0x00,0x00}, // F
        {0x3e,0x41,0x45,0x45,0x3d,0x00,0x00,0x00}, // G
        {0x7f,0x04,0x04,0x04,0x7f,0x00,0x00,0x00}, // H
        {0x41,0x7f,0x41,0x00,0x00,0x00,0x00,0x00}, // I
        {0x20,0x40,0x40,0x40,0x3f,0x00,0x00,0x00}, // J
        {0x7f,0x04,0x04,0x0a,0x71,0x00,0x00,0x00}, // K
        {0x7f,0x40,0x40,0x40,0x40,0x00,0x00,0x00}, // L
        {0x7f,0x02,0x04,0x02,0x7f,0x00,0x00,0x00}, // M
        {0x7f,0x02,0x04,0x08,0x7f,0x00,0x00,0x00}, // N
        {0x3e,0x41,0x41,0x41,0x3e,0x00,0x00,0x00}, // O
        {0x7f,0x05,0x05,0x05,0x02,0x00,0x00,0x00}, // P
        {0x3e,0x41,0x41,0x21,0x5e,0x00,0x00,0x00}, // Q
        {0x7f,0x05,0x05,0x05,0x7a,0x00,0x00,0x00}, // R
        {0x22,0x45,0x45,0x45,0x39,0x00,0x00,0x00}, // S
        {0x01,0x01,0x7f,0x01,0x01,0x00,0x00,0x00}, // T
        {0x3f,0x40,0x40,0x40,0x3f,0x00,0x00,0x00}, // U
        {0x0f,0x30,0x40,0x30,0x0f,0x00,0x00,0x00}, // V
        {0x7f,0x20,0x10,0x20,0x7f,0x00,0x00,0x00}, // W
        {0x71,0x0a,0x04,0x0a,0x71,0x00,0x00,0x00}, // X
        {0x01,0x02,0x7c,0x02,0x01,0x00,0x00,0x00}, // Y
        ...
        {0x04,0x7e,0x05,0x05,0x00,0x00,0x00,0x00}, // f
        {0x98,0xa4,0xa4,0xa4,0x7c,0x00,0x00,0x00}, // g
        {0x7f,0x08,0x04,0x04,0x78,0x00,0x00,0x00}, // h
        {0x7d,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // i
        {0x60,0x80,0x80,0x80,0x7d,0x00,0x00,0x00}, // j
        {0x7f,0x10,0x28,0x44,0x00,0x00,0x00,0x00}, // k
        {0x3f,0x40,0x00,0x00,0x00,0x00,0x00,0x00}, // l
        ...
        {0xfc,0x28,0x24,0x24,0x18,0x00,0x00,0x00}, // p
        ...
        {0x02,0x3f,0x42,0x00,0x00,0x00,0x00,0x00}, // t
        {0x3c,0x40,0x40,0x40,0x7c,0x00,0x00,0x00}, // u
        {0x1c,0x20,0x40,0x20,0x1c,0x00,0x00,0x00}, // v
        {0x3c,0x40,0x70,0x40,0x7c,0x00,0x00,0x00}, // w
...
#endif //RPI_LEDMATRIX_SERVER_MYFONT_H
